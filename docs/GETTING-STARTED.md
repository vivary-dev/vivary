...
[published 0.3.1 proof](WALKTHROUGH.md).
...
- [Published 0.3.1 proof](WALKTHROUGH.md): scaffold, doctor, review, blast radius.
- [Guide library](LEARN-BY-DOING.md): one task at a time. Published guides pin 0.3.1.
- [Command reference](COMMANDS.md): flags, outputs, and exit codes. Unreleased
  commands are marked.
- [Architecture](ARCHITECTURE.md): ownership and package boundaries.

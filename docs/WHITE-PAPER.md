...
places authorization and consent at explicit components [5]. Vivary treats MCP as a
possible interoperability surface, not as the canonical project model. A future
first slice is intentionally read-only.

...
Start here. Published stranger docs pin **0.3.1**. Unpublished 0.4.2 is checkout only.
...
| [WALKTHROUGH.md](WALKTHROUGH.md) | Published 0.3.1 full-scaffold proof. Pin 0.3.1. The 0.4.2 thin-init contract is unpublished. |

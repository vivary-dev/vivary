...
- **PyPI:** [`create-vivary`](https://pypi.org/project/create-vivary/) 0.2.4 ·
...
- **npm:** [`@vivary/create`](https://www.npmjs.com/package/@vivary/create) 0.2.4
...
> Current published release line: `create-vivary` 0.2.4 (PyPI), `@vivary/create`
> 0.2.4 (npm), `vivary-tropo` 0.2.3, `vivary-exo` 0.2.2. This line includes the
> security-hardening batch for private scaffold boundaries, hard-link-safe writes,
> and generated output paths.
> Published 0.2.4 scaffold output: 39 files, doctor ok (9 nodes, 28 edges),
> `tropo check` clean.

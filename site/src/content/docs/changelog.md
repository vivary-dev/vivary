...
- The multi-project program records the subscribed-runtime adapter direction
  ...
  isolated copies of one recorded fixture baseline. These are planning and
  verification requirements; neither runtime proof nor product integration
  is complete, and package versions remain unchanged.

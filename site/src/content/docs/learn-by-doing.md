...
The [published 0.3.1 proof](/walkthrough/) shows the full-layout scaffold.
...
|---|---|---|---|
| Start a new project | [Create a Vivary workspace](/guides/create-workspace/) | Create the published 0.3.1 full-layout scaffold. | Published 0.3.1 |
| Add Vivary to a project | [Adopt an existing project](/guides/adopt-project/) | Dry-run, then add files only. | Published 0.3.1 |
| Prove health | [Verify and recover a workspace](/guides/verify-recover/) | Validate health. Recovery hashes are 0.4.2. | Mixed |
| Give an agent context | [Connect an agent to Vivary](/guides/connect-agent/) | Use the standard route. MCP is unpublished. | Mixed |
| Retrieve evidence | [Get bounded context](/guides/get-context/) | Return task context. Task Capsule path is 0.4.2. | Mixed |
| Preserve earned context | [Write one approved record](/guides/write-record/) | Apply one capsule-bound record. | Unpublished 0.4.2 |

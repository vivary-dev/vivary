...
description: "Create and verify the published 0.3.1 full-layout Vivary scaffold."
...
See the [published 0.3.1 proof](/walkthrough/).
...
Use [Getting started](/getting-started/) for the install pins.
Use the [command reference](/commands/) for flags and output fields.

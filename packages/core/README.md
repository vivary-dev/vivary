...
The current platform-specific proof is **638 tests on Windows**. On Linux, it is
**636 passed plus 2 skips**. The suite translates the reference contracts across observation,
